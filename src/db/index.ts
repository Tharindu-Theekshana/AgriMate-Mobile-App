...
/**
 * Create tables if they don't exist. Called once at startup. We use plain DDL
 * (instead of drizzle-kit migrations) to keep the runtime self-contained.
 */
...
/** Wipe local data on logout (keep schema). */
